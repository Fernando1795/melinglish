...
export const DEMO_LEVELS: DemoLevel[] = [
  {
    ...
    modules: [
      ...
      // ══════════════════════════════════════════════════════════════════════
      {
        ...
        description: 'El alfabeto A-Z, pronunciación de letras, vocales, consonantes, deletreo y sílabas',
        emoji: '🔤',
        sections: [
          {
            id: 's1-alfabeto',
            ...
            lessons: [
              {
                ...
                key_concepts: [
                  ...
                  'Las letras suenan MUY diferente al español: J = "yei", W = "dóbol-iú", Z = "zi"',
                  'Las letras difíciles: G = "yi", R = "ar", H = "eich", Y = "uai"',
                  'Las vocales son: A (ei), E (i), I (ai), O (ou), U (iú)',
                ],
                exercises: [
                  ...
                  mc('1a3',1,{ question:'¿Cómo se pronuncia la letra "W" en inglés?', options:['double-you','doble-ve','vee','uve doble'], correct:'double-you', explanation:'"W" se llama "double-you" en inglés — ¡muy diferente al español!' }),
                  mc('1a4',1,{ question:'¿Qué letra va DESPUÉS de la G en el alfabeto?', options:['H','F','I','J'], correct:'H', explanation:'...E, F, G, H, I... La H sigue a la G.' }),
                  mc('1a5',2,{ question:'¿Cómo se pronuncia la letra "J" en inglés?', options:['jay','jota','hai','che'], correct:'jay', explanation:'"J" se dice "jay" en inglés. No suena como la J española.' }),
                  so('1a6',2,{ words:['E','H','L','L','O'], correct_order:['H','E','L','L','O'] }),
                  mc('1a7',2,{ question:'¿Qué letra va ANTES de la Z en el alfabeto?', options:['Y','X','W','V'], correct:'Y', explanation:'...X, Y, Z son las últimas tres letras.' }),
                  mc('1a8',2,{ question:'¿Cómo se pronuncia la letra "Z" en inglés americano?', options:['zee','zed','zeta','ze'], correct:'zee', explanation:'En EE.UU. se dice "zee". En Reino Unido se dice "zed".' }),
                  mc('1a9',3,{ question:'¿Cuál de estas letras se pronuncia "ar" en inglés?', options:['R','W','H','Y'], correct:'R', explanation:'"R" en inglés se llama "ar". Muy diferente a la "erre" española.' }),
                ]
              },
              {
                id: 'l1-vowels',
                title: 'Vocales, Consonantes y "A" vs "An"',
                duration_minutes: 10,
                key_concepts: [
                  'Vocales (vowels): A, E, I, O, U',
                  'Consonantes (consonants): todas las demás letras (B, C, D, F…)',
                  'Usa "AN" antes de palabras que empiezan con vocal: an apple, an egg, an orange',
                  'Usa "A" antes de palabras que empiezan con consonante: a book, a cat, a dog',
                ],
                exercises: [
                  mc('1v1',1,{ question:'¿Cuál de estas letras ES una vocal?', options:['A','B','C','D'], correct:'A', explanation:'"A" es vocal. B, C y D son consonantes.' }),
                  mc('1v2',1,{ question:'¿Cuál de estas letras NO es una vocal?', options:['B','E','I','O'], correct:'B', explanation:'"B" es consonante. E, I y O son vocales.' }),
                  mc('1v3',1,{ question:'¿Cuál es correcto: "___ apple"?', options:['an apple','a apple','the apple','one apple'], correct:'an apple', explanation:'"Apple" empieza con vocal A → usamos "AN": an apple.' }),
                  mc('1v4',1,{ question:'¿Cuál es correcto: "___ book"?', options:['a book','an book','the book','one book'], correct:'a book', explanation:'"Book" empieza con consonante B → usamos "A": a book.' }),
                  fb('1v5',2,{ sentence:'The word "APPLE" has ___ vowels: A and E.', answer:'two', hint:'Cuenta las vocales: A-P-P-L-E' }),
                  mc('1v6',2,{ question:'¿Cuáles son las vocales en la palabra "ENGLISH"?', options:['E, I','N, G','L, S','G, H'], correct:'E, I', explanation:'ENGLISH tiene dos vocales: E e I (E-N-G-L-I-S-H).' }),
                  mc('1v7',2,{ question:'¿Cuál es correcto: "___ orange"?', options:['an orange','a orange','the orange','one orange'], correct:'an orange', explanation:'"Orange" empieza con vocal O → "an orange".' }),
                  mc('1v8',3,{ question:'¿Cuál es correcto: "___ umbrella"?', options:['an umbrella','a umbrella','the umbrella','one umbrella'], correct:'an umbrella', explanation:'"Umbrella" empieza con vocal U → "an umbrella".' }),
                ]
              },
            ]
          },
            ...
            lessons: [
              {
                ...
                key_concepts: [
                  ...
                  'Deletrear = decir las letras una por una: D-O-G',
                  'Algunas palabras se escriben diferente a como suenan: SCHOOL, PHONE, KNIFE',
                  'Palabras útiles: name, school, teacher, English',
                ],
                exercises: [
                  mc('1s1',1,{ question:'¿Cómo se deletrea "CAT" (gato)?', options:['C-A-T','C-E-T','K-A-T','C-A-D'], correct:'C-A-T', explanation:'CAT = C-A-T. Tres letras, se escribe como suena.' }),
                  fb('1s2',1,{ sentence:'S-U-N spells the word ___.', answer:'sun', hint:'S-U-N → ¿qué palabra forma?' }),
                  mc('1s3',1,{ question:'B-O-O-K — ¿qué palabra es?', options:['book','cook','look','hook'], correct:'book', explanation:'B-O-O-K = "book" (libro).' }),
                  mc('1s4',2,{ question:'"How do you spell DOG?" → "___ - O - G"', options:['D','B','T','P'], correct:'D', explanation:'DOG = D-O-G. Empieza con D.' }),
                  mc('1s5',2,{ question:'T-E-A-C-H-E-R — ¿qué palabra es?', options:['teacher','teacer','teecher','teachar'], correct:'teacher', explanation:'TEACHER (maestro/a) = T-E-A-C-H-E-R. ¡Aprende a deletrearla!' }),
                  mc('1s6',2,{ question:'¿Cómo se escribe "escuela" en inglés?', options:['school','scool','skool','shkool'], correct:'school', explanation:'"School" = S-C-H-O-O-L. El sonido es "skul" pero se escribe con SCH.' }),
                  so('1s7',3,{ words:['you','your','spell','Can','name'], correct_order:['Can','you','spell','your','name'] }),
                  mc('1s8',3,{ question:'¿Cuántas letras tiene "ENGLISH"?', options:['7','6','8','5'], correct:'7', explanation:'E-N-G-L-I-S-H = 7 letras.' }),
                ]
              },
              {
                id: 'l1-silabas',
                title: 'Sílabas y acento en inglés',
                duration_minutes: 8,
                requires_audio: true,
                key_concepts: [
                  'Sílaba (syllable) = grupo de sonidos con una vocal',
                  'CAT = 1 sílaba · HAPP-Y = 2 sílabas · BEA-U-TI-FUL = 3 sílabas',
                  'El acento (stress) cae en una sílaba: hel-LO, STU-dent, un-der-STAND',
                  'Equivocarse de acento puede causar malentendidos',
                ],
                exercises: [
                  mc('1sl1',1,{ question:'"CAT" — ¿cuántas sílabas tiene?', options:['1','2','3','0'], correct:'1', explanation:'"Cat" tiene una sílaba: CAT. Una sola vocal = una sílaba.' }),
                  mc('1sl2',1,{ question:'"HAPP-Y" — ¿cuántas sílabas tiene?', options:['2','1','3','4'], correct:'2', explanation:'"Happy" se divide: HAPP-Y = 2 sílabas. Dos vocales = dos sílabas.' }),
                  mc('1sl3',2,{ question:'"EN-GLISH" — ¿cuántas sílabas tiene?', options:['2','1','3','4'], correct:'2', explanation:'EN-GLISH = 2 sílabas. EN + GLISH.' }),
                  fb('1sl4',2,{ sentence:'"BEAUTIFUL" has ___ syllables: beau-ti-ful.', answer:'three', hint:'Cuenta los grupos: beau / ti / ful' }),
                  mc('1sl5',2,{ question:'"HEL-LO" — ¿en qué sílaba cae el acento?', options:['LO','HEL','Las dos igual','No tiene acento'], correct:'LO', explanation:'hel-LO — el acento fuerte cae en la segunda sílaba: LO.' }),
                  mc('1sl6',3,{ question:'"STU-DENT" — ¿en qué sílaba cae el acento?', options:['STU','DENT','Las dos igual','No tiene acento'], correct:'STU', explanation:'STU-dent — el acento cae en la primera: STUdent.' }),
                  mc('1sl7',3,{ question:'"UN-DER-STAND" — ¿cuántas sílabas tiene?', options:['3','2','4','1'], correct:'3', explanation:'UN-DER-STAND = 3 sílabas. El acento cae en STAND.' }),
                ]
              },
            ]
          },
